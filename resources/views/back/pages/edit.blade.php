...
@endsection
	...
	<section class="content">
		{!! Form::model($page, ['route' => ['pages.update', $page->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PUT']) !!}
    	<div class="row">
    		<div class="col-md-8">
				<div class="box box-success">
					<div class="box-body">
						<div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
			        		<div class="col-lg-12">
						        <input class="form-control input-lg" id="focus" placeholder="Masukkan judul disini" name="judul" type="text" value="{{$page->title}}" required>
						        @if ($errors->has('judul'))
					    ...
					    <div class="form-group{{ $errors->has('deskripsi') ? ' has-error' : '' }}">
			                <div class="col-lg-12">
								{!! Form::textarea('deskripsi', $page->description, array('class' => 'form-control', ' rows'=>15, 'id'=>'tiny')) !!}
		            	...
		            	<div class="keterangan">
		            		<div class="col-md-12">
		            			<div class="form-group">
					                ...
					                <label>
					                  <input type="radio" value="0" name="publish" class="minimal-red" {{ $page->published==0? 'checked': '' }}>
					                  Draft
					                </label>
					                <label>
					                  <input type="radio" value="1" name="publish" class="minimal-red" {{ $page->published==1? 'checked': '' }}>
					                  Publikasi
					                </label>
				              	</div>
				            </div>
				...
				<div class="box box-info">
		            ...
		            <div class="box-body">
		            	...
		            	<div class="form-group{{ $errors->has('metadescription') ? ' has-error' : '' }}">
			        		<div class="col-lg-12">
			        			{!! Form::textarea('metadescription', $page->meta_description, array('class' => 'form-control',' rows'=>3)) !!}
					    ...
					    <div class="form-group{{ $errors->has('metakeyword') ? ' has-error' : '' }}">
			        		<div class="col-lg-12">
						        <input class="form-control" placeholder="Meta Keyword. Contoh: berita, kaltim, dll" name="metakeyword" type="text" value="{{$page->meta_keyword}}">
