...
@section('title', 'Admin | Edit Info Kecamatan')
...
@endsection
	...
	<section class="content">
		{!! Form::model($kecamatan, ['route' => ['kecamatans.update', $kecamatan->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PUT']) !!}
    	<div class="row">
    		<div class="col-md-8">
				<div class="box box-success">
					<div class="box-body">
						<div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
			        		<div class="col-lg-12">
						        <input class="form-control input-lg" id="focus" placeholder="Masukkan judul disini" name="judul" type="text" value="{{$kecamatan->title}}" required>
						        @if ($errors->has('judul'))
					    ...
					    <div class="form-group{{ $errors->has('deskripsi') ? ' has-error' : '' }}">
			                <div class="col-lg-12">
								{!! Form::textarea('deskripsi', $kecamatan->description, array('class' => 'form-control', ' rows'=>15, 'id'=>'tiny')) !!}
					...
					<div class="box-footer">
						<div class="pull-left">
			                <a href="{{ url('kukaradmin/kecamatans') }}" class="btn btn-warning">Kembali</a>
			            </div>
				...
				<div class="box box-danger">
		            ...
		            <div class="box-body">
						<div class="input-append" id="input-append" >
						  <input name="image"  id="fieldID4" type="hidden" value="{{$kecamatan->image != '' || $kecamatan->image != null ? asset('image/kabupaten/'.$kecamatan->image) : ''}}" onchange="readURL(this)">
						  @if($kecamatan->image != '' || $kecamatan->image != null)
						  <img class="img-responsive" id="blah" src="{{asset('image/kabupaten/'.$kecamatan->image)}}" alt="" ></img>
						  @else
				...
				<div class="box box-info">
		            ...
		            <div class="box-footer">
						<div class="pull-left">
			                ...
			                <a href="{{ url('kukaradmin/kecamatans/delete/'.$kecamatan->id) }}" class="delete" onclick="return delete_confirm();">Hapus Info Kecamatan ini</a>
			...
			<div class="col-md-4">
				<div class="box box-info">
		            ...
		            <div class="box-body">
							...
							<div class="col-sm-12">
								<select class="form-control" name="category" id="">
									...
									@foreach($category as $child)
										<option value="{{$child->id}}" {{$child->id == $kecamatan->category_id?'selected': ''}}>{{$child->title}}</option>
									@endforeach
								</select>
		            	...
		            	@if($kecamatan->information != null || $kecamatan->information != '')
		            		<?php $info = unserialize($kecamatan->information); ?>
		            		@foreach($info as $key => $value)
			        		<div class="col-lg-12 tambah">
			        			<input style="width:85%; float:left" class="form-control" placeholder="Kunci" name="info[]" type="text" value="{{$key}}"><button class="btn btn-default btn-xs delete-form pull-right" onClick="return deleteForm(event)">Del</button>
						        <input class="form-control" placeholder="Nilai" name="nilai[]" type="text" value="{{$value}}">
					        </div>
					        @endforeach
					    @else
					    	<div class="col-lg-12 tambah">
