<?php 
$setting = App\Setting::where('key', 'ads-250')->first(); 
...
<?php $banners = App\Banner::withDrafts()->where('startdate', '<', $carbon->now())->where('enddate','>', $carbon->now())->whereIn('id', $side['id'])->get(); ?>
								...
								@if($banners->count() > 0)	
									...
									<div class="box box-default collapsed-box box-solid" id="ads-250-{{$value}}" data-widget="ads">
							            <div class="box-header with-border">
							              	<h5 class="box-title">Iklan 250</h5> 
