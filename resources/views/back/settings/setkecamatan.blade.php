...
@section('title', 'Admin | Set Kecamatan Page')
...
<?php  $set = unserialize($setkecamatan->value); ?>
<input type="hidden" id="page-display" value="kecamatan">
<section class="content-header">
      <h1>
        Tampilan Halaman Kecamatan
      </h1>
    </section>
