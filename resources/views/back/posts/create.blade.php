...
@endsection
	...
	<section class="content">
		{!! Form::open(['route' => 'posts.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'files'=>true]) !!}
    	<div class="row">
			<div class="col-md-8">
		            ...
		            <div class="box-body">
		            	...
		            	<div class="keterangan">
		            		...
		            		<div class="col-md-12">
			            		<div class="form-group">
				            		<label>
					                  <input name="headnews" class="flat-red" type="checkbox"> Headnews
					                </label>
				            	</div>
			            	</div>
			            	<div class="col-md-12">
			            		<div class="form-group">
				            		<label>
					                  <input name="breaking" class="breaking" type="checkbox"> Breaking News (Teks Berjalan)
					                </label>
				            	</div>
			            	</div>
			            	@endcan
