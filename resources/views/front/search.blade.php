...
@section('title', 'Berita '.$search.' - '.$sitename->value)
	...
	<div id="main-content">
		<div class="col-area-3 pull-right">
			<div class="kp-breadcrumb">
				<ol class="breadcrumb">
				  <li><span>Pencarian Kata:</span></li>
			...
			<div class="list-posts clearfix">				
					    			...
					    			<div class="item-right">
					    				<?php 
					    					...
					    					for($i=0;$i<=count($highlight)-1;$i++){
					    						$high[] = '<span class="highlight">'.$highlight[$i].'</span> ';
					    					}
					    					
					    					$title = str_replace($highlight, $high, $title); 
					    					$desc = str_replace($highlight, $high, $desc); 
					    				?>
					    				<h4><a href="{{url($p->slug)}}"><?php echo $title ?></a></h4>
					    			</div>
				...
				<div class="wrap-page-links clearfix">
					<ul class="page-numbers"><li>{!! $post->appends(['s'=> $search ])->render() !!}</li></ul>
				</div>
				<div class="clearfix"></div>
			</div>
			<!-- list-post -->
