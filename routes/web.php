...
Route::group(['middleware' => ['maintenance', 'cookie']], function () {
	...
	Route::get('kukaradmin/login', 'Auth\LoginController@showLoginForm');
	Route::post('kukaradmin/login', 'Auth\LoginController@login');
	Route::get('kukaradmin/logout', 'Auth\LoginController@logout');
	...
	Route::group(['middleware' => 'auth'], function () {
		...
		Route::group(['middleware' => 'role:administrator'], function () {
			...
			Route::post('kukaradmin/saveglobal', ['as'=>'saveglobal','uses'=>'SetGlobalController@saveGlobal']);
			Route::post('kukaradmin/savecontact', ['as'=>'setcontact.store','uses'=>'SetGlobalController@saveContact']);
			Route::post('kukaradmin/saveemail', ['as'=>'setemail.store','uses'=>'SetGlobalController@saveEmail']);
			Route::post('kukaradmin/savefooter', ['as'=>'setfooter.store','uses'=>'SetGlobalController@saveFooter']);
		});
